...
import SiriChatModal from '../../components/modals/SiriChatModal';
import UploadSheetModal from '../../components/modals/UploadSheetModal';
    ...
    <View style={{ flex: 1, backgroundColor: '#fafaf8', paddingTop: 48, position: 'relative' }}>
      ...
      <View style={{
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          <Text style={{ fontSize: 16, fontWeight: '700', color: '#151515', fontFamily: 'Sora' }}>Hospitality Elite</Text>
        </View>
