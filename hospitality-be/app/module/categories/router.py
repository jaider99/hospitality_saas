...
def get_categories(
    ...
    statement = select(Category).where(Category.deleted_at == None, Category.restaurant_id == current_user.restaurant_id).order_by(Category.name)
...
def get_category(
    ...
    statement = select(Category).where(Category.id == category_id, Category.restaurant_id == current_user.restaurant_id)
...
def create_category(
    ...
    statement = select(Category).where(Category.name == category_in.name, Category.deleted_at == None, Category.restaurant_id == current_user.restaurant_id)
...
def delete_category(
    ...
    all_categories = session.exec(select(Category).where(Category.deleted_at == None, Category.restaurant_id == current_user.restaurant_id)).all()
    ...
    statement = select(Supplier).where(Supplier.category_id.in_(list(string_ids_to_check)), Supplier.deleted_at == None, Supplier.restaurant_id == current_user.restaurant_id)
